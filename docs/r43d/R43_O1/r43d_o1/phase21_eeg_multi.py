...
if __name__ == "__main__":
    ...
    print("\n[ЧЕСТНЫЙ ВЫВОД — по фактам прогона, n=20 субъектов]")
    print("  ✅ derivative-free тезис РОБАСТЕН: и R43 O1, и корреляция бьют дифф у 100%")
    print("     субъектов на ОБЕИХ группировках (дифф mean ARI 0.02–0.04 vs ~0.36).")
    print("  ❌ фаза > корреляция НЕ подтверждена на реальном ЭЭГ: win-rate R43O1>корр")
    print("     = 45% (мелко) / 30% (грубо), <50%. Средние — статистическая ничья, корреляция")
    print("     чуть впереди (0.360 vs 0.375; 0.341 vs 0.378). Победа на S001 (Ф20) была шумом.")
    print("  → Ф20 «смешанно» уточняется до твёрдого: на реальном ЭЭГ фазовый край ОТСУТСТВУЕТ")
    print("     (ничья/чуть хуже корреляции). Это не отменяет робастного ядра derivative-free.")
